...
import {getAllProjects, getProjectBySlug, getRelatedProjects, projects} from "@/lib/projects";

// Export the portfolio data
export const data = portfolioData;

// Export the projects data
export {getAllProjects, getProjectBySlug, getRelatedProjects, projects};
